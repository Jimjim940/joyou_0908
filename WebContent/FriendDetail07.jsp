        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6">
            <div class="product__details__text">
              <h3><font color="black">無奈</font></h3>
              ...
              <div class="frienddata">
               		 信箱:
                <div class="datacontent">Laishengchu7@google.com</div>
              </div>
              <br />
        ...
        <div class="row">
          <div class="col-lg-3 col-md-4 col-sm-6">
            <div class="bg-white p-3 h-100">
              <a href="FriendDetail11.jsp"
                ><img
                  class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm"
                  src="img/friendstest/friendtest11.jpg"
                  alt=""
                  width="100"
              /></a>
              <h4 class="mb-1">
                <a href="FriendDetail11.jsp"><font color="black">企鵝</font></a>
              </h4>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 col-sm-6">
