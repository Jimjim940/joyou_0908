        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6">
            <div class="product__details__text">
              <h3><font color="black">多拉A夢</font></h3>
              ...
              <div class="frienddata">
               		 信箱:
                <div class="datacontent">Laishengchu@google.com</div>
              </div>
              <br />
        ...
        <div class="row">
          <div class="col-lg-3 col-md-4 col-sm-6">
            <div class="bg-white p-3 h-100">
              ...
              /></a>
              <h4 class="mb-1">
                <a href="FriendDetail.html"><font color="black">無奈</font></a>
              </h4>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 col-sm-6">
            <div class="bg-white p-3 h-100">
              ...
              /></a>
              <h4 class="mb-1">
                <a href="FriendDetail.html"><font color="black">皮卡皮卡</font></a>
              </h4>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 col-sm-6">
            <div class="bg-white p-3 h-100">
              ...
              /></a>
              <h4 class="mb-1">
                <a href="FriendDetail.html"><font color="black">汪醬</font></a>
              </h4>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 col-sm-6">
            <div class="bg-white p-3 h-100">
              ...
              /></a>
              <h4 class="mb-1">
                <a href="FriendDetail.html"><font color="black">豬豬</font></a>
              </h4>
            </div>
          </div>
        </div>
